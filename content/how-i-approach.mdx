...
## 📝 Real-World Case: Exploiting a Misconfigured Web Server

During an internal test, I found a **misconfigured Nginx reverse proxy** exposing the admin panel of a CMS. Using `Burp Suite` and `ffuf`, I fuzzed the endpoints and retrieved credentials in a backup archive.

![Burp Suite Auth Bypass Screenshot](/images/burpsuite-bypass.png)

I reported it immediately with a **critical severity**, and remediation involved properly restricting the endpoint behind VPN access.
